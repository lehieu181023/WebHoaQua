...
loaddata = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/ChiTietDonHang/listdata", // Gọi file PHP xử lý
        type: "GET",
        data: { MaDh: id },
...
LoadModelAdd = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/ChiTietDonHang/Create", // Gọi file PHP xử lý
        type: "GET",
        success: function (response) {
            UnBlockUI();
...
LoadModelEdit = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/ChiTietDonHang/Edit", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
deleteData = function (id) {
    if (confirm("Bạn có chắc chắn muốn xóa không?")) {
        ...
        $.ajax({
            url: "/Admin/ChiTietDonHang/Delete",
            type: "POST",
            data: { id: id },
...
editStatus = function (id,status) {
    ...
    BlockUI(); // Không cho người dùng nhập liệu khi đang thao tác với dữ liệu
    $.ajax({
        url: "/Admin/ChiTietDonHang/Status",
        type: "POST",
