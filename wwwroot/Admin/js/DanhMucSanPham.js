...
loaddata = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/DanhMucSanPham/listdata", // Gọi file PHP xử lý
        type: "GET",
...
LoadModelAdd = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/DanhMucSanPham/Create", // Gọi file PHP xử lý
        type: "GET",
        success: function (response) {
            UnBlockUI();
...
LoadModelEdit = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/DanhMucSanPham/Edit", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
editStatus = function (id, status) {
    ...
    BlockUI(); // Không cho người dùng nhập liệu khi đang thao tác với dữ liệu
    $.ajax({
        url: "/Admin/DanhMucSanPham/Status",
        type: "POST",
