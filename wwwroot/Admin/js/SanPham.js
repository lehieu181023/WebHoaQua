...
loaddata = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/SanPham/listdata", // Gọi file PHP xử lý
        type: "GET",
...
LoadModelAdd = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/SanPham/Create", // Gọi file PHP xử lý
        type: "GET",
        success: function (response) {
            UnBlockUI();
...
LoadModelEdit = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/SanPham/Edit", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
